package com.android.gers.utils;
...
public class DbFromXml {
	...
	public HashMap<String, List<ContentValues>> Execute() {
		...
		try {
			...
			Log.e(ListOfLists.LOG_NAME + ".DbToXml", "Exception thrown while attempting to import db values: " + e);
			return null;
		}
		return results;
	}
	...
	{
		Log.d(ListOfLists.LOG_NAME + ".DbToXml", msg );
	}
